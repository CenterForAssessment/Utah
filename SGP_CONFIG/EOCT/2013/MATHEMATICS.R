#####################################################################################
###
### 	Scripts associated with 2013 EOCT MATHEMATICS: 
###			PRE_ALGEBRA, ALGEBRA_I, GEOMETRY & ALGEBRA_II
###
#####################################################################################


PRE_ALGEBRA_2013.config <- list(
	PRE_ALGEBRA.2013 = list(
...
ALGEBRA_I_2013.config <- list(
	
### Repeaters.
	ALGEBRA_I.2013 = list(
		sgp.content.areas=c('ALGEBRA_I', 'ALGEBRA_I'),  #  Repeaters - policy decision  
		sgp.panel.years=as.character(2012:2013),
		sgp.grade.sequences=list(c('EOCT', 'EOCT')),
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=0),
