...
SGPstateData[["UT"]][["SGP_Configuration"]][["sgp.target.scale.scores.merge"]] <- NULL
...
SGPstateData[["UT"]][["SGP_Configuration"]][["grade.projection.sequence"]] <- list(
    ...
    ELA_GRADE_9= c(3, 4, 5, 6, 7, 8, 9, 10),
    ELA_GRADE_10=c(3, 4, 5, 6, 7, 8, 9, 10),
    SCIENCE_GRADE_4=c(4, 5, 6, 7, 8, 9, 10),
    SCIENCE_GRADE_5=c(4, 5, 6, 7, 8, 9, 10),
    SCIENCE_GRADE_6=c(4, 5, 6, 7, 8, 9, 10),
    SCIENCE_GRADE_7=c(4, 5, 6, 7, 8, 9, 10),
    SCIENCE_GRADE_8=c(4, 5, 6, 7, 8, 9, 10),
    SCIENCE_GRADE_9= c(4, 5, 6, 7, 8, 9, 10),
    SCIENCE_GRADE_10=c(4, 5, 6, 7, 8, 9, 10),
...
SGPstateData[["UT"]][["SGP_Configuration"]][["content_area.projection.sequence"]] <- list(
    ...
    SCIENCE_GRADE_6=rep("SCIENCE", 7),
    SCIENCE_GRADE_7=rep("SCIENCE", 7),
    SCIENCE_GRADE_8=rep("SCIENCE", 7),
    SCIENCE_GRADE_9= rep("SCIENCE", 7),
    SCIENCE_GRADE_10=rep("SCIENCE", 7),
