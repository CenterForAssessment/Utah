###############################################################################
###                                                                         ###
###            SGP Configurations for 2023 MATHEMATICS subjects             ###
###                                                                         ###
###############################################################################
...
SEC_MATH_I.2023.config <- list(
    SEC_MATH_I.2023 = list(
...
SEC_MATH_I_Baseline.2023.config <- list(
    SEC_MATH_I_Baseline.2023 = list(
        sgp.content.areas = c("MATHEMATICS", "MATHEMATICS", "SEC_MATH_I"),
        sgp.panel.years = c("2021", "2022", "2023"),
